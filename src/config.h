#ifndef CONFIG_2022_03_28_H
  #define CONFIG_2022_03_28_H
  ...
  /* Define to 1 if you have the `_filbuf' function. */
  #undef HAVE__FILBUF

  /* Define to 1 if you have the `_flsbuf' function. */
  #undef HAVE__FLSBUF
